...
public class GiveCommand extends SubCommand {
    ...
    public String getDescription() {
        return ChatColor.GRAY + "Give a custom music disc.";
    }

    @Override
    public String getSyntax() {
        return ChatColor.GREEN + "/customdisc give <filename> \"Custom Lore\"";
    }
    ...
    public void perform(Player player, String[] args) {
        if (args.length >= 3) {
            ...
            if (!player.hasPermission("customdiscs.give")) {
            ...
            player.sendMessage(
                    ChatColor.RED + "Insufficient arguments! ( /customdisc give <filename> \"Custom Lore\" )");
        }
    }
